...
public class PrecedenceConstraint extends Constraint {
    ...
    public PrecedenceConstraint(Variable v1, Variable v2, int timeGap){
        this.v1 = v1;
        this.v2 = v2;
        ...
        v1.incNumOfConstraints();
        v2.incNumOfConstraints();
    }
    ...
    public String toString() {
        return "[" + v1.getName() + "] + " + this.timeGap + " <= [" + v2.getName() + "]";
    }
}
